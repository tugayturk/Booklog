...
const createBook = async (data: CreateBook) => {
    const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/books`, data, {
        headers: {
...
export { getBookDetails, createReview, searchBooks, getUserLibrary, createBook };